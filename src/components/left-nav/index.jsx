...
class LeftNav extends Component {
    ...
    */
    hasAuth = (item) => {
        ...
        if (user.username === 'admin' || item.public || menus.indexOf(item.key) != -1) { //eslint-disable
            return true
        } else if (item.children) {
            // 4. 如果当前用户有item的某个子节点的权限, 当前item也应该显示
            // eslint-disable-next-line eqeqeq
            const cItem = item.children.find(cItem => menus.indexOf(cItem.key) != -1) //eslint-disable
            return !!cItem
        }
